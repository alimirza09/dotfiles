...
vim.api.nvim_create_autocmd('FileType', {
  callback = function()
    ...
    -- You may also want to remove 'o' to prevent it from happening with 'o' and 'O'
...
-- Use the new function in your keymap
...
require('lazy').setup({
  ...
  --    end,
  --  },
  -- In your lazy.nvim setup table
  {
    'catppuccin/nvim',
    name = 'catppuccin',
    priority = 1000, -- Important for colorschemes to load before other plugins
    config = function()
      -- This function runs *after* the plugin has been installed
      require('catppuccin').setup {
        -- Add your specific Catppuccin options here
        -- Example: flavour = "mocha"
      }
  ...
  },
  {
    ...
    opts = {}, -- Empty table uses the default settings
